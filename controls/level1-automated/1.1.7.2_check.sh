...
check_nodev_option_home() {
    ...
    if [[ "$mount_options" == *"nodev"* ]]; then
        echo -e "1.1.7.2 Ensure nodev option set on /home partition --> \033[0;32mpassed\033[0m"
    else
        echo -e "1.1.7.2 Ensure nodev option set on /home partition --> \033[0;31mfailed\033[0m"
    fi
}
